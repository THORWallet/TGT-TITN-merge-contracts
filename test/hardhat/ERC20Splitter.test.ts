...
const RECIPIENT_1_PERCENT = 30
const RECIPIENT_2_PERCENT = 70

describe('ERC20Splitter tests', function () {
    ...
    before(async function () {
        ...
        ERC20Splitter = await ethers.getContractFactory('ERC20Splitter')
    ...
    beforeEach(async function () {
        ...
        await erc20Splitter
            .connect(ownerA)
            .setRecipients([user1.address, user2.address], [RECIPIENT_1_PERCENT, RECIPIENT_2_PERCENT])
    })
